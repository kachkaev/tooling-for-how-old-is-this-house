...
Перечисленные выше команды следует перезапускать в случае изменения исходных данных.
...
1.  Запустите геокодер и сохраните результат в кэш:
    ...
    Команда завершит свою работу при достижении лимита, а вам на электронную почту придёт письмо.
