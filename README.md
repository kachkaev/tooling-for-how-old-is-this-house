...
| | адрес | геометрия | год постройки | этажность | название | вики 🔗 | фотография |
| :- | :-: | :-: | :-: | :-: | :-: | :-: | :-: |
...
1.  **Скачать данные с Росреестра**
    ...
    Подготовка к скачиванию деталей объектов (создание файлов-страниц для хранения данных):
    ...
    Созданные файлы-страницы заканчиваются несколькими десятками пустых кадастровых номеров.
    После запуска двух предыдущих команд, списки кадастровых номеров в некоторых кварталах могут заполниться данными «под завязку».
    Это значит, что есть вероятность найти больше объектов, если добавить ещё страниц.

    Добавление страниц со списками кадастровых номеров:
