...
import { convertSectionToSemanticPart } from "./convert-section-to-semantic-part";
import { extractSections } from "./extract-sections";
import { getDesignationConfig } from "./helpers-for-designations";
import { resolveRegionCode } from "./helpers-for-regions";
import {
  AddressNodeWithWord,
  AddressSection,
