...
export const testCases: Array<{
  ...
  {
    rawAddresses: [
      "Пензенская область, г. Пенза, ул. Сиреневая, д. 257 к 1",
      "Пензенская область, г. Пенза, ул. Сиреневая, 257 к 1",
    ],
    expectedNormalizedAddress:
      "область пензенская, пенза, улица сиреневая, 257 корпус 1",
  },
  {
    rawAddresses: [
  ...
  },
  {
    ...
    expectedStandardizedAddress:
      "область пензенская, пенза, улица гагарина, 11",
  },
  {
    rawAddresses: [
  ...
  },
  {
    ...
    expectedCleanedAddress:
      "ПЕНЗЕНСКАЯ ОБЛАСТЬ, ГОРОД ПЕНЗА, РАЙОН ПЕРВОМАЙСКИЙ, УЛИЦА ВОЛГОГРАДСКАЯ/ПЕРВЫЙ КУБАНСКИЙ ПРОЕЗД ДОМ 16/1",
    expectedStandardizedAddress:
