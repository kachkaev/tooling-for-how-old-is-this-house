...
export const pickBlockFromTiles: Command = async ({ logger }) => {
  logger.log(chalk.bold("sources/rosreestr: Picking blocks from tiles"));
...
autoStartCommandIfNeeded(pickBlockFromTiles, __filename);
