...
} from "./helpers-for-approximate-pointers";
import { commonUnclassifiedWordConfigLookup } from "./helpers-for-common-unclassified-words";
import {
  designationAdjectiveConfigLookup,
  isNormalizedDesignationAdjective,
} from "./helpers-for-designation-adjectives";
import {
...
} from "./helpers-for-ordinal-numbers";
